	                                                    ...
	                                                    current_number(2)
{
	...
	source = new int* [width] {0};
	for (int i = 0; i < width; ++i)
	{
		source[i] = new int[height] {0};
		way_net[i] = new int[height] {0};
		picture[i] = new char[height] {0};
...
bool Algoritm::algoritm_1()
{
	clean_way_net();
	fill_number_one();

	int* start_coords = nullptr;
	start_coords = FindNumberCoords_1();
...
bool Algoritm::algoritm_2()
{
	clean_way_net();
	fill_number_one();

	int* start_coords = nullptr;
	start_coords = FindNumberCoords_2();
...
bool Algoritm::algoritm_3()
{
	clean_way_net();
	fill_number_one();

	int* start_coords = nullptr;
	start_coords = FindNumberCoords_3();
...
bool Algoritm::algoritm_4()
{
	clean_way_net();
	fill_number_one();

	int* start_coords = nullptr;
	start_coords = FindNumberCoords_4();
...
int* Algoritm::FindNumberCoords_1()
{
...
int* Algoritm::FindNumberCoords_2()
{
	while (current_number < width * height)
	{
...
int* Algoritm::FindNumberCoords_3()
{
	while (current_number < width * height)
	{
		for (int i = 0; i < width; i++)
...
int* Algoritm::FindNumberCoords_4()
{
	while (current_number < width * height)
	{
		for (int i = width - 1; i >= 0; i--)
